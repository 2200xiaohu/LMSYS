...
class InstructionDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        labels = [-100] * (len(input_ids) - 2) + label_ids + [-100]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Demo of argparse')
    parser.add_argument('--config', default='train_gemma2_instruction_one_label.yaml', type=str, help='Path to the config file', required=False)
    args = parser.parse_args()
