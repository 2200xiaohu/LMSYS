...
def train(args):
    ...
    peft_config = LoraConfig(
        ...
        #bias = 'none',
        target_modules=['query_key_value'] # Target specific modules
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Demo of argparse')
    parser.add_argument('--config', default='train_chatglm_instruction.yaml', type=str, help='Path to the config file', required=False)
    args = parser.parse_args()
